...
python /../tama/tama_go/format_converter/tama_format_gff_to_bed12_cupcake.py  PP_DP_N_filtereddegradationama_NOCAP_sqanti2_classification.filtered_lite.gtf  PP_DP_N_filtereddegradationama_NOCAP_sqanti2_classification.filtered_lite_nofus.gtf.bed
...
python /..tama/tama_go/format_converter/tama_convert_bed_gtf_ensembl_no_cds.py mergedpc2filterdegradationtama.nofus.gtf.bed mergedpc2filtereddegradationama.nofus.gtf
