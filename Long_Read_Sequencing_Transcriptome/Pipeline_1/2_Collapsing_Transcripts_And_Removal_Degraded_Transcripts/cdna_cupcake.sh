...
singularity exec -B /../CUPCAKE,/../LONG_READS_ISOSEQ3,/../GMAP /projects/globalscratch/cdna_cupcake.sif collapse_isoforms_by_sam.py --input /../LONG_READS_ISOSEQ3/hq_transcripts.fasta  -s  /../GMAP/highquality_gmap_sorted.sam -o  /../CUPCAKE/highquality_gmap_sorted_cupcake.collapsed --dun-merge-5-shorter --max_fuzzy_junction=5
