...
tama_remove_fragment_models.py -f /../TAMA/highquality_desalt_sorted_tama.collapsed_nocap.bed -o /../TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered.bed -e 100

#get gtf file from the bed file
python tama_convert_bed_gtf_ensembl_no_cds.py /../TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered.bed /../TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered.gtf
