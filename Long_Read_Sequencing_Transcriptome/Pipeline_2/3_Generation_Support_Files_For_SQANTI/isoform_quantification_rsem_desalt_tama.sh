...
#script to generate isoform abundance files for SQANTI3
...
#will generate 3 files, including .isoforms.results, and one folder. .isoforms.results file will be used for SQANTI3
