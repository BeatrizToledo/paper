...
/../SQANTI_INPUT_DESALT_TAMA/DT.rsemSTAR_L223.isoforms.results \
    -fl /../SQANTI_INPUT_DESALT_TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered_full-length_count.txt -o /../SQANTI_DESALT_TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered_sqanti \
    --isoAnnotLite --gff3 /../SQANTI_INPUT_DESALT_TAMA/Mus_musculus_GRCm38_Ensembl_86.gff3 \
    -c /../SQANTI_INPUT_DESALT_TAMA/L356_twopassDTSJ.out.tab,/../SQANTI_INPUT_DESALT_TAMA/L223_twopassDTSJ.out.tab,\
/../SQANTI_INPUT_DESALT_TAMA/L394_twopassDTSJ.out.tab,/../SQANTI_INPUT_DESALT_TAMA/L357_twopassDTSJ.out.tab,\
/../SQANTI_INPUT_DESALT_TAMA/L224_twopassDTSJ.out.tab,/../SQANTI_INPUT_DESALT_TAMA/L395_twopassDTSJ.out.tab,\
/../SQANTI_INPUT_DESALT_TAMA/L355_twopassDTSJ.out.tab,/../SQANTI_INPUT_DESALT_TAMA/L222_twopassDTSJ.out.tab,\
/../SQANTI_INPUT_DESALT_TAMA/L393_twopassDTSJ.out.tab

#filter out artifacts and degraded transcripts
singularity exec -B /../SQANTI3_DESALT_TAMA \
    /projects/globalscratch/sqanti3_3.0.sif \
    python /../SQANTI_DESALT_TAMA/sqanti3_RulesFilter.pyhighquality_desalt_sorted_tama.collapsed_nocap.filtered_sqanti_classification.txt \
    /../SQANTI_DESALT_TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered_sqanti_corrected.fasta \
    /../SQANTI_DESALT_TAMA/highquality_desalt_sorted_tama.collapsed_nocap.filtered_sqanti_corrected.gtf
