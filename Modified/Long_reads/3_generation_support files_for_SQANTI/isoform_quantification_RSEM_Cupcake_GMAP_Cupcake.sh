...
#calculate expression using short-reads data from the same cell types used for the long-read sequencing. Calculate expression for each replicate separately
